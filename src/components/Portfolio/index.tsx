...
const Portfolio = () => {
    ...
    return (
        <>
            ...
            <p className={`${theme === 'light' ? 'text-neutral-900' : 'text-neutral-300'} w-full mb-6 text-center lg:text-3xl text-4xl font-bold`}>Portfolio</p>
            <div className={`${theme === 'light' ? 'text-neutral-900' : 'text-neutral-300'} lg:px-24 py-4 w-full gap-4 flex lg:flex-row flex-col justify-evenly items-center`}>
                <div
