...
const MoreAboutMe = ({openMoreInfo}: { openMoreInfo: Dispatch<SetStateAction<boolean>> }) => {
    ...
    return (
        ...
        fixed z-40 bg-inherit w-full h-full flex justify-center items-center`}>
            <div className={'flex flex-col justify-center items-center mobile:w-[70%] w-[50%] lg:max-w-[500px]'}>
                ...
                <div>
                    <h1 className={'font-mono mobile:text-8xl text-6xl lg:text-4xl text-center mb-8 tracking-wide'}>
                        Experience
                    </h1>
                    <h2 className={'mobile:text-5xl text-3xl lg:text-xl italic font-bold'}>
                        Frontend Web Developer in PJSC SberBank
                    </h2>
                    <h3 className={'mobile:text-5xl text-3xl lg:text-xl font-mono mb-4 tracking-tight'}>
                        09/2021 – 08/2023
                    </h3>
                    <p className={'mobile:text-5xl text-3xl lg:text-xl font-sans mb-8 text-justify'}>
                    ...
                    <div className={'flex justify-center items-center mt-16 mobile:text-5xl text-3xl lg:text-xl'}>
                        <a
                            href={cv}
                            target="_blank"
                        >
