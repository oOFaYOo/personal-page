...
const Skills = () => {
    ...
    return (
        ...
        mt-16 mb-24 py-32 overflow-hidden`}>
            <a id={'skills-anchor'}/>
            <div ref={refBlock} className={`px-24 flex flex-row flex-wrap items-stretch gap-16 justify-evenly w-full 
            ${isVisible ? 'anim-active' : 'anim translate-y-[20%]'}`}>
                ...
                <img className={`${theme === 'light' ? '' : 'invert' } absolute right-4 -translate-y-20 duration-500 opacity-[0.05] w-[500px] h-[500px]`} src={css_icon} />
                    ...
                    <p className={`${isVisible ? 'anim-active' : 'anim translate-x-[-50%]'} hover:text-sky-500 text-4xl mobile:text-5xl text-center italic`}>React Router</p>
                    <p className={`${isVisible ? 'anim-active' : 'anim translate-x-[100%]'} hover:text-sky-500 text-5xl mobile:text-6xl text-center font-serif`}>HTML</p>
                    <p className={`${isVisible ? 'anim-active' : 'anim translate-x-[-50%]'} hover:text-sky-500 text-4xl mobile:text-5xl text-center italic`}>React Testing Library</p>
                <div
