...
const Portfolio = () => {
    ...
    return (
        ...
        <div className={'px-24 py-4 w-full gap-4 flex lg:flex-row flex-col justify-evenly items-center'}>
            <div className={'lg:h-[90%] min-h-[500px] h-[35%] p-6 w-[80%] lg:w-[45%] rounded-xl flex flex-col items-center justify-between overflow-hidden bg-neutral-300'}>
                <img className={'rounded-xl w-full mb-4'} src={demo1}/>
                ...
                <div className={'flex w-full flex-row justify-evenly items-center mt-4'}>
                    <a href={'https://yearly-goal-tracker.vercel.app/yearly_goal_tracker/auth'}
                        className={'w-[45%] py-1 font-semibold bg-sky-500 rounded-3xl flex items-center justify-center text-xl'}>
            ...
            <div className={'lg:h-[90%] min-h-[500px] h-[35%] p-6 w-[80%] lg:w-[45%] rounded-xl flex flex-col items-center justify-between overflow-hidden bg-neutral-300'}>
                <img className={'rounded-xl w-full mb-4'} src={demo2}/>
                <p className={'text-justify'}>
